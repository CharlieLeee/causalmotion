...
e='0-0-0-200-100-700' # Notice: if use sam, better cut the inv and decoder training to half to keep fairness
...
do  
    ...
    do
        exp="contrast_dual_style_causaldecode_${norm}_OOD_without_inv"
